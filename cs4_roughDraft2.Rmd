...
Finally the `scrape_data()` function that puts everything together to build the list of years and scrape the data for both genders. Currently, the function will retrieve the list of years outlined in this Case Study (1999-2012), and for **both** genders, but it could be modified. This function would allow the web scraping to be called as a script file.
...
df_all_mens <- read_csv("data/allDataMen.csv", 
...
``` {r SummaryDataframes, eval=FALSE, include=FALSE}
...
```{r get_all_data, eval=FALSE, include=FALSE}
